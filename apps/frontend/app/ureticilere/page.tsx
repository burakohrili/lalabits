...
import UreticilerClient from './_components/ureticiler-client';

export const metadata: Metadata = {
  title: "İçerik Üreticileri — lalabits.art",
  description:
...
export default async function UreticilerePage({ searchParams }: PageProps) {
  ...
  return (
    <main className="bg-background min-h-screen">
      ...
      <section className="bg-white border-b border-border py-12">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="mt-3 text-lg text-text-secondary max-w-xl">
            Türkiye'nin en iyi içerik üreticilerini keşfet, destekle ve topluluğun parçası ol.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <UreticilerClient initialData={initialData} initialCategory={category} />
      </div>
    </main>
  );
}

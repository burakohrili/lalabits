  ...
  return (
    <div className="px-6 py-8 max-w-4xl">
      ...
      <p className="text-sm text-neutral-500 mb-6">
        Platformdaki yolculuğunun dönüm noktaları
      </p>
      ...
      {loading ? (
        ...
        <MilestoneBadgeList
          milestones={items}
          emptyMessage="Henüz rozet kazanmadın. İlk gönderini yayınla veya üreticileri desteklemeye başla!"
        />
      )}
    </div>
  );
